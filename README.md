...
This project simulates a simplified version of Scrabble, where the
player places words on a grid using randomly generated letters.
...
-   Game ends when the player reaches 3 points
...
Install dependency: pip install tabulate
...
This project was developed as part of the CS50P (Introduction to
Programming with Python) course.

It was created as a learning exercise to practice Python fundamentals
and problem-solving through building a small game.
